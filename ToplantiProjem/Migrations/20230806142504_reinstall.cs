...
namespace ToplantiProjem.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToplantiTuruId = table.Column<int>(type: "int", nullable: false),
                    Dokuman = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Duyurular", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Duyurular_Toplantilar_ToplantiTuruId",
                        column: x => x.ToplantiTuruId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Duyurular_ToplantiTuruId",
                table: "Duyurular",
                column: "ToplantiTuruId");
        }
